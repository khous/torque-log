INSERT IGNORE INTO pids (pid, description)
VALUES
  ...
  ('kff1257','CO2 in g/km (Instantaneous)'),
  ('kff1258','CO2 in g/km (Average)'),
  ...
  ('kff1201',	'MPG'),
  ('kff1202',	'Turbo Boost'),
  ('kff1203',	'Kilometers Per Litre'),
  ('kff1205',	'Trip MPG'),
  ('kff1206',	'Trip KPL'),
  ('kff1207',	'Litres per Kilometre'),
  ('kff1208',	'Trip LPK'),
  ('kff120A',	'Manifold Vacuum'),
  ('kff120B',	'GPS Trip distance'),
  ('kff120C',	'Vehicle distance (Odometer) saved with profile'),
  ('kff1220',	'Accelerometer (X)'),
  ('kff1221',	'Accelerometer (Y)'),
  ('kff1222',	'Accelerometer (Z)'),
  ('kff1223',	'Accelerometer (Total)'),
  ('kff1225',	'Torque'),
  ('kff1226',	'Horsepower'),
  ('kff122d',	'0-60 mph time'),
  ('kff122e',	'0-100 kph time'),
  ('kff122f',	'Quarter mile time'),
  ('kff1230',	'eighth mile time'),
  ('kff1237',	'GPS vs OBD speed diff'),
  ('kff1238',	'Voltage'),
  ('kff1239',	'GPS Accuracy'),
  ('kff123A',	'GPS Satellites locked'),
  ('kff123B',	'GPS bearing'),
  ('kff1249',	'AFR'),
  ('kff1214', 'O2 Sensor 1 Bank 1'),
  ('kff1215', 'O2 Sensor 2 Bank 1'),
  ('kff1216', 'O2 Sensor 3 Bank 1'),
  ('kff1217', 'O2 Sensor 4 Bank 1'),
  ('kff1218', 'O2 Sensor 1 Bank 2'),
  ('kff1219', 'O2 Sensor 2 Bank 2'),
  ('kff121A', 'O2 Sensor 3 Bank 2'),
  ('kff121B', 'O2 Sensor 4 Bank 2'),
  ('kff1240', 'O2 Eqv Ratio 1'),
  ('kff1241', 'O2 Eqv Ratio 2'),
  ('kff1242', 'O2 Eqv Ratio 3'),
  ('kff1243', 'O2 Eqv Ratio 4'),
  ('kff1244', 'O2 Eqv Ratio 5'),
  ('kff1245', 'O2 Eqv Ratio 6'),
  ('kff1246', 'O2 Eqv Ratio 7'),
  ('kff1247', 'O2 Eqv Ratio 8'),
  ('kff1257',	'CO2 in G/KM'),
  ('kff1258',	'CO2 in G/KM average'),
  ('kff125a',	'Fuel rate'),
  ('kff125b',	'Fuel cost (trip)'),
  ('kff125c',	'Fuel used (trip)'),
  ('kff1255',	'Torque RPM component'),
  ('kff1256',	'HorsePower RPM component'),
  ('kff124d',	'Commanded AFR'),
  ('kff1249',	'Measured AFR');